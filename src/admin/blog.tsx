...
const EditPageHelper = (post: any, isDraft: boolean, versions: any[]) => { return html`
    ${PostForm(post, isDraft)}
    ${VersionsListHelper(versions)}
` }

const ViewVersionHelper = (version: any, diffContent: string) => { return html`
